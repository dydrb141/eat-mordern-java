...
|두 객체 비교|(Apple a1, Apple a2) -> a1.getWeght().compareTo(a2.getWeight()) |BiFunction<Apple, Apple, Integer> or ToIntBiFunction<Apple, Apple>| 
...
3. Predicate<Apple>은 test라는 한 개의 추상 메서드를 정의한 함수형 인터페이스
...
### Comparator조합
Comparator.comparing을 이용해서 비교에 사용할 키를 추출
Comparator 의 comparing은 디폴트 메서
